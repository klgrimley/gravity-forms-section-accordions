...
class GF_Field_Section_Accordion extends GF_Field {

	public $type = 'accordion';

	public function get_form_editor_field_title() {
		return esc_attr__( 'Accordion', 'sectionaccordions' );
	}
	...
	public function get_form_editor_field_description() {
		return esc_attr__( 'Adds an accordion to your form to help organize groups of fields. This is a visual element and does not collect any data.', 'sectionaccordions' );
	}
...
GF_Fields::register( new GF_Field_Section_Accordion() );